...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    description: {
      ...
      de: 'Statischer Astro-Build pro Sprache hinter nginx Content Negotiation — als Docker-Image aus GitHub Actions, self-hosted auf dem Homelab.',
    },
  ...
  },
  {
    ...
    description: {
      ...
      de: 'Ein selbst gehosteter Speedtest-Analyzer, der meine Leitung rund um die Uhr vermisst — läuft aus meinem eigenen Fork.',
    },
